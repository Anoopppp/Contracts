...
contract MKD is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 25_000 * 10**18;
    ...
    address public marketingWallet = 0xE0B03c643864338850F4C8b43f67b3f64538337c;
    address public devWallet = 0xc25166e92903390570f2C2315024317d9eAC842f;
    address public gamedevWallet = 0x3475CB2aFce284C4464FFbb347FB945f08A51f09;
    ...
    Taxes public sellTaxes = Taxes(2, 3, 2, 1);
    ...
    constructor(address routerAdd) ERC20("Metakingdom Defenders", "MKD") {
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 gamedevAmt = unitBalance * 2 * swapTaxes.gamedev;
            if (gamedevAmt > 0) {
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _gamedev, _dev);
        require((_marketing + _liquidity + _gamedev + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity,  _gamedev, _dev);
        require((_marketing + _liquidity + _gamedev + _dev) <= 20, "Must keep fees at 20% or less");
    }
